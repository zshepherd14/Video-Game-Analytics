key<-"RGAPI-6d3008c1-2796-44e8-bc02-9919d093b705"
...
SummonerData<-findSummonerData("zjsbears",key)
dfAll<-summonerdata[1]
dfAll<-dfAll[1]
dfAll<-as.data.frame(dfAll)
summary<-summonerdata[3]
summary<-summary[1]
...
summary$rune<-paste(
  paste(summary$perk0Name,"Above Averager %: ",summary$perk0Below,", ",summary$perk0var1Measure," Your Avg:",summary$perk0Var1PlayerAvg," Game Avg:",summary$perk0Var1GameAvg,
  ...
  paste(summary$perk1Name,"Above Averager %: ",summary$perk1Below,", ",summary$perk1var1Measure," Your Avg:",summary$perk1Var1PlayerAvg," Game Avg:",summary$perk1Var1GameAvg,
  ...
  paste(summary$perk2Name,"Above Averager %: ",summary$perk2Below,", ",summary$perk2var1Measure," Your Avg:",summary$perk2Var1PlayerAvg," Game Avg:",summary$perk2Var1GameAvg,
  ...
  paste(summary$perk3Name,"Above Averager %: ",summary$perk3Below,", ",summary$perk3var1Measure," Your Avg:",summary$perk3Var1PlayerAvg," Game Avg:",summary$perk3Var1GameAvg,
  ...
  paste(summary$perk4Name,"Above Averager %: ",summary$perk4Below,", ",summary$perk4var1Measure," Your Avg:",summary$perk4Var1PlayerAvg," Game Avg:",summary$perk4Var1GameAvg,
  ...
  paste(summary$perk5Name,"Above Averager %: ",summary$perk5Below,", ",summary$perk5var1Measure," Your Avg:",summary$perk5Var1PlayerAvg," Game Avg:",summary$perk5Var1GameAvg,
...
colnames(summary)<-c("Champion","Games Played","Win %","KDA","Kill Part", "Average Damage", "AVerage Damage Taken", "Runes")

runes<-runes[order(runes$perk),]
runes<-runes[,c(1:5)]
colnames(runes)<-c("Rune","Measure 1","Average of Measure 1","Measure 2","Average of Measure 2","Measure 3","Average of Measure 3")
